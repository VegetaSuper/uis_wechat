...
export const nativeTabbarList: NativeTabBarItem[] = [
  {
    ...
    selectedIconPath: '/static/tabbar/index1_a.png',
    pagePath: 'pages/index/index',
    text: '首页'
  },
  {
    iconPath: '/static/tabbar/index2.png',
    selectedIconPath: '/static/tabbar/index2_a.png',
    pagePath: 'pages/task/index',
    text: '我的任务'
  },
  {
    iconPath: '/static/tabbar/index3.png',
    selectedIconPath: '/static/tabbar/index3_a.png',
    pagePath: 'pages/chance/index',
    text: '机会'
  },
  {
...
export const customTabbarList: CustomTabBarItem[] = [
  {
    ...
    pagePath: 'pages/index/index',
    iconType: 'image',
    icon: '/static/tabbar/index1.png',
    iconActive: '/static/tabbar/index1_a.png'
  },
  {
    text: '我的任务',
    pagePath: 'pages/task/index',
    iconType: 'image',
    icon: '/static/tabbar/index2.png',
    iconActive: '/static/tabbar/index2_a.png'
  },
  {
    text: '机会',
    pagePath: 'pages/chance/index',
    iconType: 'image',
    icon: '/static/tabbar/index3.png',
    iconActive: '/static/tabbar/index3_a.png'
  },
  {
    pagePath: 'pages/my/index',
    text: '我的',
...
export const TABBAR_THREE: CustomTabBarItem[] = [
  {
    text: '首页',
    pagePath: 'pages/index/index',
    iconType: 'image',
...
export const TABBAR_FOUR: CustomTabBarItem[] = [
  {
    text: '首页',
    pagePath: 'pages/index/index',
    iconType: 'image',
