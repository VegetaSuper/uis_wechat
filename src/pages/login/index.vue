...
<template>
  <view class="flex flex-col justify-center items-center px-10%">
    ...
    <view class="indent-72rpx text-36rpx">
      本小程序（嘉胜石化）仅限上海嘉胜石油化工有限公司<text class="text-primary">内部员工</text>使用，用于公司内部管理，不对外开放。本小程序需使用预设的手机号码登录方可使用。
    </view>
    <button class="w-80% mt-40%" open-type="getPhoneNumber" @getphonenumber="getPhoneNumber"
      type='primary'>使用手机号码登录</button>
  </view>
</template>
